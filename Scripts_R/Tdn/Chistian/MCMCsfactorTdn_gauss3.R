...
title(xlab="Energy (MeV)", line=2, cex.lab=1.7)
title(ylab="S-Factor (MeV b)", line=2, cex.lab=1.7)
...
# plot reaction label
text(0.007, 27, labels=expression(paste(NULL^"3","H(d,n)",NULL^"4","He")), cex=1.7)
######################################################################
...
plot(density(
GammaTdn(samplesmat[,1], samplesmat[,4], samplesmat[,3], samplesmat[,11], samplesmat[,10])$Ga
), main="", xlab="", ylab="",
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5)
...
GammaTdn(samplesmat[,1], samplesmat[,4], samplesmat[,3], samplesmat[,11], samplesmat[,10])$Gb
     ...
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5)
title(xlab=expression(paste(Gamma [n], " (MeV)")), line=4.0, cex.lab=2.3)

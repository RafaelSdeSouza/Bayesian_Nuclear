...
*-------------------------------------------------------------------*
      integer ret
      ret=0
      call He3dp_AD_Sub(ret)
      end

c     -----------------------------------------------------------
      subroutine He3dp_AD_Sub(ret)
...
!     "hm" is Pierre's constant (hbar.c)^2/(2u) i.e. (197.3)^2/(2*931) = 20.9
      ...
      data q/18.353053/ ! Bar97

      open(unit=11,file='He3dp_AD.out',status='unknown')	
      open(unit=12,file='He3dp_AD.in',status='unknown')	

...
!     "hm" is Pierre's constant (hbar.c)^2/(2u) i.e. (197.3)^2/(2*931) = 20.9
      ...
      data a1i,a2i,z1i,z2i/3,2,2,1/
      data a1f,a2f,z1f,z2f/4,1,2,1/
      data q/18.353053/ ! Bar97

      open(unit=11,file='He3dp.out',status='unknown')	
      open(unit=12,file='He3dp.in',status='unknown')	

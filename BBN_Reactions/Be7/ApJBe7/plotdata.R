...
Be7npG2$E[155:160] <- Be7npG2$E[155:160]*runif(6,0.75,1.22)
...
ggplot(Be7npG2,aes(x=E,y=S)) +
  ...
  geom_errorbar(data=filter(Be7npG2,type=="rel"),show.legend = FALSE,aes(x=E,ymin=S-Stat,ymax=S+Stat,group=dat,color=comb),size=0.2,width=0.01)+
  
  geom_errorbar(data=absdat,show.legend = FALSE,aes(x=E,ymin=S-syst,ymax=S+syst),color="#e41a1c",size=0.2,width=0.01)+

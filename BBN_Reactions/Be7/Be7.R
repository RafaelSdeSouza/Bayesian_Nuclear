...
#obsx1 <- runif(N,0,0.7)
tau <- 0.1
obsx1 <- exp(runif(N,log(1e-3),log(100)))
errobsy1 <- runif(N,0.05,0.1)
y1 <- rnorm(N, sfactor3Hedp(obsx1,0.00267,0.225,1.41) + 
               sfactor3Hedp(obsx1,0.330,0.0767,0.088) +
               sfactor3Hedp(obsx1,2.66,0.490,0.610)
              ,errobsy1)

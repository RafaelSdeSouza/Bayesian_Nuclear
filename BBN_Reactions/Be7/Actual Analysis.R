...
sigmaBe7mod <- nimbleRcall(function(ecm = double(0),
...
samplerConst <- list(obsx1 = obsx1, obsx2 = obsx2, obsx3 = obsx3, obsx4 = obsx4,
                     obsx10 = obsx10, obsx11 = obsx11, obsx12 = obsx12, obsx13 = obsx13,
...
save(mcmcChain, file = "Final2.RData")
...
pdf("Final2b.pdf",width=10,height=5,onefile=F)

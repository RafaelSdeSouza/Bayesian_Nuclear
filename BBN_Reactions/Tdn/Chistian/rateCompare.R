# plots rate ratios and comparison to literature
...
Norm <- read.table("numRates.dat",header = TRUE)$median

new <- read.table("numRates.dat",header = TRUE) %>%
...
pdf("rateCompare.pdf",height = 7,width = 10,onefile=F)

#ifndef SFACTOR3HEDP_5P_H_
#define SFACTOR3HEDP_5P_H_
 ...
 * <pre>
 * obsy1 = sfactor3Hedp(obsx1, e1, gi, gf, ri, rf)
 * </pre>
 */

class sfactor3Hedp_5p : public ArrayFunction {
    public:
	sfactor3Hedp_5p();

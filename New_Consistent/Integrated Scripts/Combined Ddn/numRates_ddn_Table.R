...
numRates_ddn_table <- function(mcmcobj, vars, N = 1000){
  ...
  gdat <-  sapply(Tgrid,function(Tgrid){numRates_ddn(a,T9 = Tgrid)})
  # Multiple Integration
  # Different temperature at different columns 
  # Recall that numRates_ddn does integration and return a list of the different reaction rates
  # for EACH chain

...
setwd(paste("C:/Users/Hong Kiat/Desktop/UROPS Materials/UROPS 1 - Thermonuclear",
            "Reaction Rates/Working Folder/Integrated 3Heag/Combined 3Heag",sep = " "))
source("numRates_3Heag.R")
source("numRates_3Heag_Table.R")
...
## Set this to the working directory where you can find ensamble_3Heag.csv. This 
# is also the directory where the pdf that are outputted will be found in
setwd(paste("C:/Users/Hong Kiat/Desktop/UROPS Materials/UROPS 1 - Thermonuclear",
      "Reaction Rates/Working Folder/Integrated 3Heag/Combined 3Heag",sep = " "))

## Change the directory accordingly
ensamble <- read.csv("ensamble_3Heag.csv",header = T,fileEncoding="UTF-8-BOM") 
...
syst = c(log(1.03),log(1.031),log(1.05),log(1.051))
# In accordance to 
# bro07 = 1, 3.0% = log(1.03)
# cos08 = 2, 3.1% = log(1.031)
# dil09 = 3, 5% = log(1.05)
# nar04 = 4, 5.1% = log(1.051)
M <- 500
...
hist(numRates_3Heag(apost,0.01))
...
Nrate  <- numRates_3Heag_table(samplesmat,vars = "a.scale", N = 5000)
...
# plot legend
legend(1.3, 6e-4, legend=c("Bro09", "Cos08", "Dil09", "Nar04"), 
...
plot(1, type="n", lwd=2, col="black",  ylim=c(0, 6), xlim=c(4.8, 6.5),
...
plot(1, type="n", lwd=2, col="black",  
     main="", xlab="", ylab="", axes=FALSE, xlim=c(0.87, 1.07), ylim=c(1,30),
     cex=10.5, cex.main=10.0, cex.lab=2.0, cex.axis=1.3, log="", yaxs='i', xaxs='i')
...
# plot #1          
plot(density(samplesmat[,6]*1e4), main="", xlab="", ylab="", xlim=c(0, 1.5),
...
# plot #2                  
plot(density(samplesmat[,7]*1e4), main="", xlab="", ylab="", xlim=c(0, 1),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
)
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
      yaxs='i', xaxs='i')
...
# plot #3                  
plot(density(samplesmat[,8]*1e4), main="", xlab="", ylab="", xlim=c(0, 0.5),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
)
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
      yaxs='i', xaxs='i')
...
# plot #4                  
plot(density(samplesmat[,9]*1e4), main="", xlab="", ylab="", xlim=c(0, 2),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
)
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
      yaxs='i', xaxs='i')
...
# %>% pipes to tibble
pdf("MCMC_3Heag_h.pdf",width=10, height=6, onefile=F)
...
for (i in 1:6){
  data[,i] <- numRates_3Heag(apost,tpts[i])
...
require(xtable)
#write.csv(Nrate,"rates_3Heag.csv",row.names = F)

...
# output all results
capture.output(print(samplesmat, print.gap=3), file="MCMCresultsDdn")
...
text(0.01, 0.17, labels=expression(paste("D(d,n)",NULL^"3","He")), cex=2.0)
...
# plot #3                  
plot(density(samplesmat[,9]*1e2), main="", xlab="", ylab="", xlim=c(0, 0.8),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
     )
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
     yaxs='i', xaxs='i')
...
# plot #5                  
plot(density(samplesmat[,11]*1e2), main="", xlab="", ylab="", xlim=c(0, 2.5),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
     )
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
     yaxs='i', xaxs='i')

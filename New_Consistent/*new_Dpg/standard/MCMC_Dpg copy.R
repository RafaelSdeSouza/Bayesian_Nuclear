...
text(4e-3, 2.0e-6, labels=expression(paste("D(p,",gamma,")",NULL^"3","He")), cex=2.0)
...
# add data BYS08 - diamonds
points( obsx2, obsy2, col="red", pch=5, cex=1.2 )
add.error.bars( obsx2, obsy2, 0.0, errobsy2, 0.0, col="red" )

# add data SCH97 - squares
points( obsx3, obsy3, col="green4", pch=0, cex=1.2 )

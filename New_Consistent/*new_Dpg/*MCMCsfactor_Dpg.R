...
# - theory relation from Marcucci et al., PRL 116, 102501 (2016)
#
# PURPOSE: 
...
# extrinsic scatter in S-factor
  yscat1 ~ dnorm(0.0, pow(2e-6, -2))T(0,)       # sigma assumed to be 2e-6 MeVb
...
# output all results
capture.output(print(samplesmat, print.gap=3), file="MCMCresultsDpg")

# select first column [a.scale] from matrix
...
# plot legend
legend(0.12, 3e-7, legend=c("Ma97", "Bys08", "Sch97", "Cas02"), pch=c(1, 0, 6, 5))
...
# plot legend
legend(0.12, 3e-7, legend=c("Ma97", "Bys08", "Sch97", "Cas02" ), 
...
# plot #1          
plot(density(samplesmat[,6]*1e7), main="", xlab="", ylab="", xlim=c(0, 10),
...
# plot #2                  
plot(density(samplesmat[,7]*1e7), main="", xlab="", ylab="", xlim=c(0, 5),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
     )
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
     yaxs='i', xaxs='i')
...
# plot #3                  
plot(density(samplesmat[,8]*1e7), main="", xlab="", ylab="", xlim=c(0, 1.5),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
     )
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
     yaxs='i', xaxs='i')
...
# plot #4                  
plot(density(samplesmat[,9]*1e7), main="", xlab="", ylab="", xlim=c(0, 0.4),
     cex=10.5, cex.main=10.0, cex.lab=2.3, cex.axis=1.5, yaxs='i', xaxs='i'
     )
title(xlab=expression(paste(sigma [S], " (MeVb)")), line=4.0, cex.lab=2.3, 
     yaxs='i', xaxs='i')

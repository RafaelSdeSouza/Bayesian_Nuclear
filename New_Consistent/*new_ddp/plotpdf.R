...
# first
histRes <- hist(data1, plot=FALSE, breaks=100)
...
# third
histRes <- hist(data3, plot=FALSE, breaks=100)
xvals <- histRes$breaks
yvals <- histRes$counts
xvals <- c(xvals,xvals[length(xvals)])
yvals <- c(0,yvals,0)
...
# fifth
histRes <- hist(data5, plot=FALSE, breaks=100)
xvals <- histRes$breaks
yvals <- histRes$counts
xvals <- c(xvals,xvals[length(xvals)])
yvals <- c(0,yvals,0)
...
# second
histRes <- hist(data2, plot=FALSE, breaks=100)
xvals <- histRes$breaks
yvals <- histRes$counts
xvals <- c(xvals,xvals[length(xvals)])
yvals <- c(0,yvals,0)
...
# fourth
histRes <- hist(data4, plot=FALSE, breaks=100)
xvals <- histRes$breaks
yvals <- histRes$counts
xvals <- c(xvals,xvals[length(xvals)])
yvals <- c(0,yvals,0)
...
# sixth
histRes <- hist(data6, plot=FALSE, breaks=100)
xvals <- histRes$breaks
yvals <- histRes$counts
xvals <- c(xvals,xvals[length(xvals)])
yvals <- c(0,yvals,0)

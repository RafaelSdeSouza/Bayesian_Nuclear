...
# energy eigenvalue 
  e0_1 ~ dnorm(0.0, pow(0.01136, -2))T(0,)         # positive since we see sigma peak 
...
# energy eigenvalue 
  e0_2 ~ dnorm(0.17, pow(0.010, -2))T(0,)         # positive since we see sigma peak 
...
logsigma1 <- log(1.01)   # factor uncertainty is 1.0xx, i.e. x.x% for Dam18

y.norm2 ~ dnorm(0.0, pow(10, -2))T(0,)
   # no absolute normalization was determined in Koe88; choose weakly 
   # informative prior
...
# plot legend
legend(0.5, 10.0, legend=c("Dam18", "Koe88"), 
        pch=c(1, 4), 
        col=c("gray40", "gray40"))
...
# add data 
points( obsx2, obsy2, col="gray40", pch=4, cex=1.2 )
add.error.bars(obsx1, obsy1, 0.0, errobsy1, 0.0, col="gray40" )  
